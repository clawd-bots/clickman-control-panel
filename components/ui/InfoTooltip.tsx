...
export default function InfoTooltip({ metric }: { metric: string }) {
  ...
  return (
    <span className="relative inline-flex ml-1">
      ...
      {show && (
        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 p-3 rounded-lg bg-bg-elevated border border-border text-xs text-text-secondary leading-relaxed shadow-xl">
